...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/architecture-supervisord.svg" alt="Lab 22 supervisord architecture"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/docker%20--version.png" alt="Docker and Compose versions"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%203%20docker%20compose%20up.png" alt="Broker stack running"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2011%20Build%20and%20start%20the%20app.png" alt="App stack built and started"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2012%20Confirm%20both%20programs%20are%20running.png" alt="supervisorctl status showing web + celery RUNNING"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/hostname%20-I.png" alt="hostname -I output"></p>
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/LB_IP.%20Loadbalancer.png" alt="Load Balancer modal with LB_IP entry"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2014%20Trigger%20a%20job%20from%20the%20LB%20URL.png" alt="Triggering a job via the LB URL"></p>
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2014%20Tail%20the%20worker%20log.png" alt="Worker log tail showing job ticks"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2015%20Kill%20the%20worker%20and%20watch%20it%20recover.png" alt="Worker back to RUNNING with a new PID"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2016%20Stop%20the%20stack.png" alt="App and broker stacks stopped"></p>

### systemd path (Steps 17–30)

<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/architecture-systemd.svg" alt="Lab 22 systemd architecture"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2017%20Reuse%20the%20broker%20stack%20for%20systemd.png" alt="Broker stack reused for the systemd path"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2024%20Install%20the%20worker%20dependencies.png" alt="Worker booting in the foreground and reporting ready"></p>
...
<p align="center"><img src="https://github.com/poridhioss/Module_60_Message-Brokers-for-Celery/blob/main/module-61/lab-22/images/Step%2027%20Expose%20port%205000%20in%20the%20lab%20UI.png" alt="Expose port 5000 in the lab UI for the systemd path"></p>
...
You ran the same Celery worker under two supervisors — `supervisord` for in-container processes, `systemd` for host-level services — and watched both restart it after a crash.
Pick `supervisord` when the worker shares a container with the API; pick `systemd` when it runs on the host alongside the broker and needs to start on boot.
